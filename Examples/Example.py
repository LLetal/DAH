...
b = "Detector"
o = "Me"
t = "r84rvXMT_hF1TpSGNaO3Sk_yhzBwYWJJP22NzYk_hU-r1djCtdd6oEtc3z4hPDBXdTkmSuubk2Frg-7DF_oQkA=="
...
def pid_loop(thermometer_usb, hardware1, hardware2,setup_name_list, pid, command1="VOLT?", command2="MEAS:CURR?", temperature=30):
    while True:
...
pid_init = pidsetup(0.00125,0.00003 ,0.00125, 180)

input_list = flux_setup(b, o,"experimentH", "Hardware")

power_sup, maxigauge = hardware('USB0::0x2A8D::0x3002::MY59001350::INSTR','ASRL6::INSTR')

pid_loop('spy://COM7', power_sup, maxigauge, input_list, pid_init)